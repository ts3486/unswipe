...
function buildInsights(
  ...
  if (bestDow.count > 0) {
    insights.push(`You resist most on ${DOW_LABELS[bestDow.dayOfWeek] ?? 'weekdays'}`);
  }
  ...
  if (lastWeekResists > 0) {
    ...
    insights.push(`${thisWeekResists} resist${thisWeekResists > 1 ? 's' : ''} this week — great start`);
  }
...
export function WeeklyInsightCard({
  ...
  const insights = buildInsights(dowCounts, timeCounts, thisWeekResists, lastWeekResists);
